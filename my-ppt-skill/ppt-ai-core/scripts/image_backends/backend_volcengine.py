...
def _resolve_size(aspect_ratio: str, image_size: str) -> str:
    ...
    if not size:
        ...
        raise ValueError(f"Unsupported aspect ratio '{aspect_ratio}' for Volcengine backend. Supported: {supported}")
    return size
...
def generate(
    ...
    api_key = require_api_key(
        ...
        "ARK_API_KEY",
        message=(
            "No API key found. Set VOLCENGINE_API_KEY or ARK_API_KEY "
