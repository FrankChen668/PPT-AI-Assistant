...
class BatchValidator:
    ...
    def print_summary(self) -> None:
        ...
        print(f"  [OK] Fully valid: {self.summary['valid']} ({self._percentage(self.summary['valid'])}%)")
        print(
        ...
        if self.summary["has_errors"] > 0 or self.summary["has_warnings"] > 0:
            ...
            if self.summary["missing_readme"] > 0:
                ...
                print("     Reference: examples/google_annual_report_ppt169_20251116/README.md")
    ...
    def export_report(self, output_file: str = "validation_report.txt") -> None:
        ...
        with open(output_file, "w", encoding="utf-8") as f:
            ...
            for result in self.results:
                ...
                f.write(f"Format: {result['format']} | SVG: {result['svg_count']} file(s)\n")
