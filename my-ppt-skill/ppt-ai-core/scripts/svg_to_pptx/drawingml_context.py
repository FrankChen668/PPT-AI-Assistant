...
class ConvertContext:
    ...
    conversion_stats: dict[str, object] | None = None
    critical_content: bool = False
    canvas_area: float = 1280.0 * 720.0
    ...
    def child(
        ...
        return ConvertContext(
            ...
            critical_content=self.critical_content or critical_content,
