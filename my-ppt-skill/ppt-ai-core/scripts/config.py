...
# Repository root directory (this repo's git root)
REPO_ROOT = PROJECT_ROOT.parent.parent

# In this repository, runnable projects live under `my-ppt-skill/projects/`
# (not under the git root). Keep `EXAMPLES_DIR` at repo root for optional use,
# but point `PROJECTS_DIR` to the skill root.
SKILL_ROOT = PROJECT_ROOT.parent
